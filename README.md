...
| `PUT /item/:id/comentario/:cid`    | `{  descricao: String }`                                                                                                                        | `{  descricao: String,  data: String,  gostos: Number }`                                                                                                                                     | `{  erro: String }`   | Editar um comentário                     |
| `DELETE /item/:id/comentario/:cid` | -                                                                                                                                             | `{  descricao: String }`                                                                                                                                                                     | `{  erro: String }`   | Remover um comentário                    |
